...
//============================================================================================================================================
//
//Version Description: SPS standalone configuration. Takes in >5V and outputs a serial string as noted in the COMPASS System Information Documentation.
//
//=============================================================================================================================================
//=============================================================================================================================================
//           ____                                    
...
struct systemData{                                                      // Data structure fot the entire system. This includes a data structure for the SPS and the GPS, so they are nested structures
  ...
  float PressureATM = 0, PressurePSI = 0, PressureAnalogPSI = 0, PressureAnalogATM = 0;
  spsData_abv spsB_data_abv;
